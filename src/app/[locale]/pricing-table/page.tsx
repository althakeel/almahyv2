...
export default async function Page({
  ...
  const PricingCard = ({
    ...
    >
      ...
      {/* Button */}
      <Link
        href={`https://wa.me/971504096028?text=Hello, I would like to know more about the ${name}`}
        target="_blank"
    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 shadow-2xl">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <Link
            href={`https://wa.me/971504096028?text=Hello, I need a custom pricing plan`}
            target="_blank"
            rel="noopener noreferrer"
