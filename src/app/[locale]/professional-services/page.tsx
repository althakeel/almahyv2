      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="relative max-w-[1250px] mx-auto px-4 md:px-8 py-20">
          <div className="max-w-2xl">
            ...
            <a
              href="https://wa.me/971542185535?text=Hello%2C%20I%20would%20like%20to%20schedule%20a%20consultation"
              target="_blank"
      ...
      <section className="relative w-full h-[450px] overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center px-4">
          <div className="text-center max-w-4xl">
            ...
            <a
              href="https://wa.me/971542185535?text=Hello%2C%20I%20would%20like%20to%20get%20a%20quote%20for%20professional%20services"
              target="_blank"
              rel="noopener noreferrer"
